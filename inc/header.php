...
<body>
    ...
    <header class="header">
        ...
        <ul class="navbar__top js--navbar__top" id="navbar__top">
            ...
            <li class="navbar__item"><a href="#" class="navbar__link">Airdrop</a></li>
            ...
            <li class="navbar__item navbar__extra-item" id="sign__in"><button class="navbar__link btn btn__outline--white navbar__btn--white">Sign In</button></li>
            <li class="navbar__item navbar__extra-item" id="sign__up"><button href="" class="navbar__link btn btn__outline--white navbar__btn--purple">Sign Out</button></li>
        </ul>
    </nav>
    </header>